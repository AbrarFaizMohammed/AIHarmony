...
var advancedStaggeringAnimation = (function () {
    ...
    var grid = [8, 8]; // Adjust the grid size accordingly
    var cell = 25; // Adjust the cell size accordingly
    ...
    var index = anime.random(0, numberOfElements - 20);
    var nextIndex = 0;

    anime.set('.stagger-visualizer .cursor', {
        translateX: anime.stagger('-' + (cell / 2) + 'px', { grid: grid, from: index, axis: 'x' }),
        translateY: anime.stagger('-' + (cell / 2) + 'px', { grid: grid, from: index, axis: 'y' }),
        translateZ: 0,
        scale: 1.5,
        zIndex: 0, // Ensure cursor is behind the dots
    });
